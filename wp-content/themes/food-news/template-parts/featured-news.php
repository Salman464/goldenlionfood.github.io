<?php if( get_theme_mod( 'featured_news_display_option', true ) ) : ?>
  
  <?php $post_details = get_theme_mod( 'featured_news_show_hide_details', array( 'date', 'categories', 'tags' ) ); ?>

  <?php
    
      $category_id = get_theme_mod( 'featured_news_category' );
      $title = get_theme_mod( 'featured_news_section_title' );
  ...
  <?php
    if ( $query->have_posts() && $posts_per_page ) :  
      $layout = get_theme_mod( 'food_news_featured_layouts', '1' );      
  ...
  ?>
      ...
      <div class="featured-blog spacer"> 
        <div class="<?php echo esc_attr( $width_class ); ?>">
          ...
          <?php endif; ?>
          <div class="featured-layout featured-blog-view">
                  ...
                  <div class="summary">
                        ...
                        <ul class="list-inline">
                          ...
                          <?php if( in_array( 'number_of_comments', $post_details ) ) { ?>
                            <li>
                              ...
                              <?php comments_popup_link( __( 'zero comment', 'food-news' ), __( 'one comment', 'food-news' ), __( '% comments', 'food-news' ) ); ?>
                            </li>
                          <?php } ?>
                    ...
                    <?php if( in_array( 'read-more', $post_details ) ) { ?>
                      ...
                      <a href="<?php echo esc_url( get_permalink() ); ?>" rel="bookmark" title="" class="readmore">
                        <?php echo esc_html( get_theme_mod( 'readmore_text', __( 'Read More', 'food-news' ) ) ); ?>                
                      </a>
                    <?php } ?>
